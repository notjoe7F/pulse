...
public class BlockPitcherMajor extends AbstractModDirectionalBlock {
    public BlockPitcherMajor() {
        super("pitcher_major", Material.WOOD);
    }
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TilePitcher(Scales.MAJOR);
    }
}
