...
public class BlockPitcherMinor extends AbstractModDirectionalBlock {
    public BlockPitcherMinor() {
        super("pitcher_minor", Material.WOOD);
    }
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TilePitcher(Scales.NATURAL_MINOR);
    }
}
